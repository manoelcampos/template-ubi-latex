...
== Introdução
O presente projeto é uma versão *NÃO OFICIAL* do modelo em LaTeX de teses e dissertações da http://www.ubi.pt[Universidade da Beira Interior (UBI)] de acordo com o despacho reitoral nº 2019/R/630.
...
Uma versão compilada para PDF está disponível para visualização no ficheiro link:{pdf_link}[Thesis.pdf].
