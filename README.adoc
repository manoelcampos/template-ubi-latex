:pdf_link: https://github.com/manoelcampos/template-ubi-latex/blob/gh-pages/Tese.pdf
...
image:imagens/capa-tese-exemplo.png[link={pdf_link}]
...
Uma versão compilada para PDF está disponível para visualização no ficheiro link:{pdf_link}[Tese.pdf].
