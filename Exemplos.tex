...
Pode-se calcular a corrente que circula na resistência através da Equação \ref{for:ohm}, denominada de Lei de Ohm\index{Lei de Ohm}. Tal lei foi criada pelo físico alemão Georg Simon Ohm, e a partir dele 
o Ohm ($\Omega$) foi definido como unidade de resistência elétrica no Sistema Internacional de Unidades (SI)\nomenclature{SI}{Sistema Internacional de Unidades}.
